...
// ==== Invoke marbles ====
// set-chain-env.sh   -i '{"Args":["initMarble","marble1","blue","35","tom"]}'
// set-chain-env.sh   -i '{"Args":["initMarble","marble2","red","50","tom"]}'
// set-chain-env.sh   -i '{"Args":["initMarble","marble3","blue","70","tom"]}'
// set-chain-env.sh   -i '{"Args":["transferMarble","marble2","jerry"]}'
// set-chain-env.sh   -i '{"Args":["transferMarblesBasedOnColor","blue","jerry"]}'
// set-chain-env.sh   -i '{"Args":["delete","marble1"]}'

// ==== Query marbles ====
// set-chain-env.sh   -q '{"Args":["readMarble","marble1"]}'
// set-chain-env.sh   -q '{"Args":["getMarblesByRange","marble1","marble3"]}'
// set-chain-env.sh   -q '{"Args":["getHistoryForMarble","marble1"]}'

// Rich Query (Only supported if CouchDB is used as state database):
// set-chain-env.sh   -q '{"Args":["queryMarblesByOwner","tom"]}'
// set-chain-env.sh   -q '{"Args":["queryMarbles","{\"selector\":{\"owner\":\"tom\"}}"]}'

// Rich Query with Pagination (Only supported if CouchDB is used as state database):
// set-chain-env.sh   -q '{"Args":["queryMarblesWithPagination","{\"selector\":{\"owner\":\"tom\"}}","3",""]}'
...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface) pb.Response {
	...
	// TODO serialize and put publickey in the blockchain, and then retrive it at every invoke
